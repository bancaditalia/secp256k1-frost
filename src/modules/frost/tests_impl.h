...
void test_secp256k1_frost_keygen_finalize_invalid_commitments(void) {
    ...
    secp256k1_fe_set_int(&_invalidPoint.z, 1);
    _invalidPoint.infinity = 0;
    secp256k1_frost_gej_serialize(dkg_commitment[0]->coefficient_commitments[0].data, &_invalidPoint);
...
void test_serialize_and_deserialize_point(void) {
    ...
    secp256k1_frost_gej_serialize(serialized64, &point);
...
void test_serialize_and_deserialize_frost_signature(void) {
    ...
    /* Serialize and deserialize */
    secp256k1_frost_signature_serialize(serialized65, &signature);
    CHECK(secp256k1_frost_signature_deserialize(&deserialized_signature, serialized65) == 1);
...
void test_secp256k1_frost_pubkey_save_and_load(void) {
    ...
    secp256k1_frost_gej_serialize(reference_pubkey.public_key, &ref_pk);
...
void test_secp256k1_frost_verify_to_be_valid(void) {
    ...
    secp256k1_frost_signature_serialize(serialized_signature, &signature);
...
void test_secp256k1_frost_verify_null_signature(void) {
    ...
    int result;
    const unsigned char msg32[32] = {'z', 's', 'd', 'W', '0', 't', 'L', '5', 'j', 'v', '9', 'd', '1', 'S', 'Z', 's', 'I', 'O', 'U', 'i', 'D', 'I', 'I', 'w', 'W', 'X', '7', 'n', '6', 'r', 'g', 'g'};
    unsigned char *serialized_signature = NULL;
    secp256k1_frost_pubkey pubkey;
