...
void test_h2c_rfc9380_expand_message_xmd(void) {
    int i;
    int ietf_rfc9380_exp_test_vectors;

    ietf_rfc9380_exp_test_vectors = sizeof(ietf_rfc9380_expander_test_vectors)/sizeof(ietf_rfc9380_expander_test_vector);
    for (i = 0; i < ietf_rfc9380_exp_test_vectors; i++) {
        ...
        dst_length = sizeof(ietf_rfc9380_exp_dst);
        ...
        result = memcmp(dst_prime, ietf_rfc9380_exp_dst_prime, sizeof(ietf_rfc9380_exp_dst_prime));
        ...
        result = expand_message_xmd(uniform_bytes, &ietf_rfc9380_exp_msgs[tv->msg_offset], tv->msg_len,
                                    ietf_rfc9380_exp_dst, dst_length,
                                    len_in_bytes);
