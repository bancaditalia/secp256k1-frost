...
Usage:
$ tools/frost_generate_ietf_h2c_rfc9380_test_vectors.py \
...
def parse_and_translate_test_vectors(filename: str, encoding: str):
    ...
    print("/* ****** ****** ****** ****** ****** ****** ****** ****** ****** ******  */")
    print()
    print(f"static const unsigned char ietf_rfc9380_{encoding.lower()}_dst[] = {{ {string_as_char_array} }};")
    print()
    ...
    for i in range(num_vectors):
        ...
        if len_Px == 0:
            len_Px = len(vector["P.x"]) // 2
        if len_Py == 0:
            len_Py = len(vector["P.y"]) // 2
        if len_u0 == 0:
            len_u0 = len(vector["u[0]"]) // 2
        if encoding.lower() == "ro":
            if len_u1 == 0:
                len_u1 = len(vector["u[1]"]) // 2
            if len_q0x == 0:
                len_q0x = len(vector["Q0.x"]) // 2
            if len_q0y == 0:
                len_q0y = len(vector["Q0.y"]) // 2
            if len_q1x == 0:
                len_q1x = len(vector["Q1.x"]) // 2
            if len_q1y == 0:
                len_q1y = len(vector["Q1.y"]) // 2
        else:
            if len_q0x == 0:
                len_q0x = len(vector["Q.x"]) // 2
            if len_q0y == 0:
                len_q0y = len(vector["Q.y"]) // 2
    ...
    print(f"#define IETF_RFC9380_{encoding.upper()}_Px_SIZE {len_Px}")
    print(f"#define IETF_RFC9380_{encoding.upper()}_Py_SIZE {len_Py}")
    print(f"#define IETF_RFC9380_{encoding.upper()}_u0_SIZE {len_u0}")
    if encoding.lower() == "ro":
        print(f"#define IETF_RFC9380_{encoding.upper()}_u1_SIZE {len_u1}")
        print(f"#define IETF_RFC9380_{encoding.upper()}_Q0x_SIZE {len_q0x}")
        print(f"#define IETF_RFC9380_{encoding.upper()}_Q0y_SIZE {len_q0y}")
        print(f"#define IETF_RFC9380_{encoding.upper()}_Q1x_SIZE {len_q1x}")
        print(f"#define IETF_RFC9380_{encoding.upper()}_Q1y_SIZE {len_q1y}")
    else:
        print(f"#define IETF_RFC9380_{encoding.upper()}_Qx_SIZE {len_q0x}")
        print(f"#define IETF_RFC9380_{encoding.upper()}_Qy_SIZE {len_q0y}")
    print()
    ...
    print()
    print(f"static const ietf_rfc9380_test_vector ietf_rfc9380_{encoding.lower()}_test_vectors[] = {{")
    print(out)
    print("};")
    print("/* ****** ****** ****** ****** ****** ****** ****** ****** ****** ******  */")
    print()
...
if __name__ == "__main__":
    ...
    print()
    print("#ifndef IETF_H2C_RFC9380_TEST_VECTORS_H")
    print("#define IETF_H2C_RFC9380_TEST_VECTORS_H")
    print()
    ...
    if len(sys.argv) < 3:
        ...
        print(" - ietf_h2c_rfc9380_ro_test_vectors.json")
        print(" - ietf_h2c_rfc9380_nu_test_vectors.json")
        sys.exit(1)
    ...
    print("#endif /* IETF_H2C_RFC9380_TEST_VECTORS_H */")
