...
static bigint_internal* test_case_inputs[] = {{{",\n    ".join(f"&test_case_input_{i}" for i in range(len(tests)))}}};
static unsigned char* expected_outputs[] = {{{",\n    ".join(f"expected_output_{i}" for i in range(len(tests)))}}};
