...
Usage:
> python tools/test_vectors_ietf_frost_rfc9591_generate.py \
...
print("/* Note: this file was autogenerated using test_vectors_ietf_frost_rfc9591_generate.py. Do not edit. */")
print("")
...
print(f"static const size_t ietf_frost_message_length      = {str(int(len(doc['group_input_parameters']['message']) / 2))};")
...
print(
    f"#define IETF_FROST_PARTICIPANT_SHARE_SIZE {str(int(len(doc['signer_input_parameters']['participant_share'][0]) / 2))}")
